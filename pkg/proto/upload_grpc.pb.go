...
type FileService_UploadClient interface {
	...
	Recv() (*FileRecivedNotification, error)
	grpc.ClientStream
}
...
func (x *fileServiceUploadClient) Recv() (*FileRecivedNotification, error) {
	m := new(FileRecivedNotification)
...
type FileService_UploadServer interface {
	Send(*FileRecivedNotification) error
...
func (x *fileServiceUploadServer) Send(m *FileRecivedNotification) error {
